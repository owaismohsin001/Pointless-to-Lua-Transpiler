...
isEmpty = PtlsThunk.create(function() return PtlsFunc.create(function (list) return (list():equaled((PtlsLabel.create("Empty"):locate(PtlsLocation.create(1, 25, "example"))))) end):locate(PtlsLocation.create(1, 1, "example"))  end) ;
head = PtlsThunk.create(function() return PtlsFunc.create(function (list) return (list():getProperty("!getHead")():locate(PtlsLocation.create(2, 18, "example"))) end):locate(PtlsLocation.create(2, 1, "example"))  end) ;
tail = PtlsThunk.create(function() return PtlsFunc.create(function (list) return (list():getProperty("!getTail")():locate(PtlsLocation.create(3, 18, "example"))) end):locate(PtlsLocation.create(3, 1, "example"))  end) ;
take = PtlsThunk.create(function() return PtlsFunc.create(function (n) return PtlsFunc.create(function (list) return ((n():lessThaned((PtlsNumber.create(1.0):locate(PtlsLocation.create(6, 10, "example"))))):is_true() and (PtlsList.fromValues({}):locate(PtlsLocation.create(6, 17, "example"))) or ((isEmpty()(PtlsThunk.create(function() return list() end))):is_true() and (PtlsList.fromValues({}):locate(PtlsLocation.create(7, 30, "example"))) or ((PtlsList.fromValues({(head()(PtlsThunk.create(function() return list() end)))}):locate(PtlsLocation.create(8, 8, "example"))):concat(PtlsThunk.create(function() return (take()(PtlsThunk.create(function() return (n():subbed((PtlsNumber.create(1.0):locate(PtlsLocation.create(8, 33, "example"))))) end))(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return list() end))) end))) end))))) end):locate(PtlsLocation.create(5, 1, "example"))  end):locate(PtlsLocation.create(5, 1, "example"))  end) ;
infinityFrom = PtlsThunk.create(function() return PtlsFunc.create(function (n) return ((PtlsList.fromValues({n()}):locate(PtlsLocation.create(10, 19, "example"))):concat(PtlsThunk.create(function() return (infinityFrom()(PtlsThunk.create(function() return (n():added((PtlsNumber.create(1.0):locate(PtlsLocation.create(10, 41, "example"))))) end))) end))) end):locate(PtlsLocation.create(10, 1, "example"))  end) ;
reduce = PtlsThunk.create(function() return PtlsFunc.create(function (func) return PtlsFunc.create(function (acc) return PtlsFunc.create(function (list) return ((isEmpty()(PtlsThunk.create(function() return list() end))):is_true() and acc() or (reduce()(PtlsThunk.create(function() return func() end))(PtlsThunk.create(function() return (func()(PtlsThunk.create(function() return acc() end))(PtlsThunk.create(function() return (head()(PtlsThunk.create(function() return list() end))) end))) end))(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return list() end))) end)))) end):locate(PtlsLocation.create(12, 1, "example"))  end):locate(PtlsLocation.create(12, 1, "example"))  end):locate(PtlsLocation.create(12, 1, "example"))  end) ;
filter = PtlsThunk.create(function() return PtlsFunc.create(function (func) return PtlsFunc.create(function (list) return ((isEmpty()(PtlsThunk.create(function() return list() end))):is_true() and (PtlsList.fromValues({}):locate(PtlsLocation.create(17, 25, "example"))) or ((func()(PtlsThunk.create(function() return (head()(PtlsThunk.create(function() return list() end))) end))):is_true() and ((PtlsList.fromValues({(head()(PtlsThunk.create(function() return list() end)))}):locate(PtlsLocation.create(20, 10, "example"))):concat(PtlsThunk.create(function() return (filter()(PtlsThunk.create(function() return func() end))(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return list() end))) end))) end))) or (filter()(PtlsThunk.create(function() return func() end))(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return list() end))) end))))) end):locate(PtlsLocation.create(16, 1, "example"))  end):locate(PtlsLocation.create(16, 1, "example"))  end) ;
map = PtlsThunk.create(function() return PtlsFunc.create(function (func) return PtlsFunc.create(function (list) return ((isEmpty()(PtlsThunk.create(function() return list() end))):is_true() and (PtlsList.fromValues({}):locate(PtlsLocation.create(25, 25, "example"))) or ((PtlsList.fromValues({(func()(PtlsThunk.create(function() return (head()(PtlsThunk.create(function() return list() end))) end)))}):locate(PtlsLocation.create(26, 8, "example"))):concat(PtlsThunk.create(function() return (map()(PtlsThunk.create(function() return func() end))(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return list() end))) end))) end)))) end):locate(PtlsLocation.create(24, 1, "example"))  end):locate(PtlsLocation.create(24, 1, "example"))  end) ;
concatMap = PtlsThunk.create(function() return PtlsFunc.create(function (func) return PtlsFunc.create(function (lists) return (concat()(PtlsThunk.create(function() return ((map()(PtlsThunk.create(function() return func() end)))(PtlsThunk.create(function() return lists() end))) end))) end):locate(PtlsLocation.create(28, 1, "example"))  end):locate(PtlsLocation.create(28, 1, "example"))  end) ;
concat = PtlsThunk.create(function() return PtlsFunc.create(function (lists) return ((isEmpty()(PtlsThunk.create(function() return lists() end))):is_true() and (PtlsList.fromValues({}):locate(PtlsLocation.create(30, 26, "example"))) or ((head()(PtlsThunk.create(function() return lists() end))):concat(PtlsThunk.create(function() return (concat()(PtlsThunk.create(function() return (tail()(PtlsThunk.create(function() return lists() end))) end))) end)))) end):locate(PtlsLocation.create(29, 1, "example"))  end) ;
sum = PtlsThunk.create(function() return PtlsFunc.create(function (list) return (reduce()(PtlsThunk.create(function() return PtlsFunc.create(function (a) return PtlsFunc.create(function (b) return (a():added(b())) end):locate(PtlsLocation.create(33, 27, "example"))  end):locate(PtlsLocation.create(33, 27, "example"))  end))(PtlsThunk.create(function() return (PtlsNumber.create(0.0):locate(PtlsLocation.create(33, 35, "example"))) end))(PtlsThunk.create(function() return list() end))) end):locate(PtlsLocation.create(33, 1, "example"))  end) ;
multiply = PtlsThunk.create(function() return PtlsFunc.create(function (list) return (reduce()(PtlsThunk.create(function() return PtlsFunc.create(function (a) return PtlsFunc.create(function (b) return (a():muled(b())) end):locate(PtlsLocation.create(35, 32, "example"))  end):locate(PtlsLocation.create(35, 32, "example"))  end))(PtlsThunk.create(function() return (PtlsNumber.create(1.0):locate(PtlsLocation.create(35, 40, "example"))) end))(PtlsThunk.create(function() return list() end))) end):locate(PtlsLocation.create(35, 1, "example"))  end) ;
range = PtlsThunk.create(function() return PtlsFunc.create(function (init) return PtlsFunc.create(function (count) return (((take()(PtlsThunk.create(function() return count() end))):added((PtlsNumber.create(8.0):locate(PtlsLocation.create(38, 39, "example")))))(PtlsThunk.create(function() return (infinityFrom()(PtlsThunk.create(function() return init() end))) end))) end):locate(PtlsLocation.create(37, 1, "example"))  end):locate(PtlsLocation.create(37, 1, "example"))  end) ;
output = PtlsThunk.create(function() return (PtlsList.fromValues({(multiply()(PtlsThunk.create(function() return ((range()(PtlsThunk.create(function() return (PtlsNumber.create(1.0):locate(PtlsLocation.create(45, 20, "example"))) end)))(PtlsThunk.create(function() return (sum()(PtlsThunk.create(function() return ((map()(PtlsThunk.create(function() return PtlsFunc.create(function (n) return (n():powed((PtlsNumber.create(2.0):locate(PtlsLocation.create(43, 26, "example"))))) end):locate(PtlsLocation.create(43, 20, "example"))  end)))(PtlsThunk.create(function() return ((filter()(PtlsThunk.create(function() return PtlsFunc.create(function (n) return (n():notEqualed((PtlsNumber.create(3.0):locate(PtlsLocation.create(42, 29, "example"))))) end):locate(PtlsLocation.create(42, 23, "example"))  end)))(PtlsThunk.create(function() return (concatMap()(PtlsThunk.create(function() return PtlsFunc.create(function (i) return (PtlsList.fromValues({i()}):locate(PtlsLocation.create(41, 33, "example"))) end):locate(PtlsLocation.create(41, 12, "example"))  end))(PtlsThunk.create(function() return (range()(PtlsThunk.create(function() return (PtlsNumber.create(1.0):locate(PtlsLocation.create(41, 27, "example"))) end))(PtlsThunk.create(function() return (PtlsNumber.create(4.0):locate(PtlsLocation.create(41, 30, "example"))) end))) end))) end))) end))) end))) end))) end)))}):locate(PtlsLocation.create(40, 10, "example"))) end) ;
try(
        output,
        function(err)
                print(debug.traceback())
