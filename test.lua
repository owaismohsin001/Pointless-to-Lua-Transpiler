...
range = PtlsThunk.create(function() return PtlsFunc.create(function (init) return PtlsFunc.create(function (count) return ((take()(PtlsThunk.create(function() return count() end)))(PtlsThunk.create(function() return (infinityFrom()(PtlsThunk.create(function() return init() end))) end))) end):locate(PtlsLocation.create(37, 1, "example"))  end):locate(PtlsLocation.create(37, 1, "example"))  end) ;
