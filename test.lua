...
--
local filename__ = 'program'
local obj;
local output;


obj = PtlsThunk.create(function() return (PtlsObject.create({arr = PtlsThunk.create(function() return (PtlsArray.fromSet({(PtlsNumber.create(1.0):locate(PtlsLocation.create(2, 10, "program"))), (PtlsNumber.create(2.0):locate(PtlsLocation.create(2, 12, "program"))), (PtlsNumber.create(3.0):locate(PtlsLocation.create(2, 14, "program"))), (PtlsNumber.create(4.0):locate(PtlsLocation.create(2, 16, "program"))), (PtlsNumber.create(5.0):locate(PtlsLocation.create(2, 18, "program")))}):locate(PtlsLocation.create(2, 9, "program"))) end) ;
}):locate(PtlsLocation.create(1, 7, "program"))) end) ;
output = PtlsThunk.create(function() return (function()
local meta__ = obj();
meta__ = meta__:updateField("arr", (meta__:getProperty("arr")():locate(PtlsLocation.create(5, 20, "program"))):updateIndex((PtlsNumber.create(1.0):locate(PtlsLocation.create(5, 25, "program"))), (PtlsNumber.create(9.0):locate(PtlsLocation.create(5, 30, "program")))));
return meta__
end)() end) ;
try(
        output,
